...
export const assignments: Assignment[] = [
  ...
  },
  {
    ...
    type: 'PDF',
    driveLink: 'https://drive.google.com/file/d/1VboqHF9Cjm7c6G9JAobfKg-Y2_sxMKfa/preview',
    description: 'An informative document outlining the objectives and achievements of the Digital India Mission.',
    createdAt: '2024-12-13',
    resources: [],
  },
  {
    ...
    title: 'Cyber Hygiene',
    type: 'PDF',
    driveLink: 'https://drive.google.com/file/d/1PP9sKE_i_omF1SEEfgS_lULcGX-wq3-z/preview',
    description: 'Guide on best practices to maintain cyber hygiene for secure online interactions.',
    createdAt: '2024-12-13',
    resources: [],
  },
  {
